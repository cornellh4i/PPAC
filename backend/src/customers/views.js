...
customerRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(200).send(yield controllers_1.default.getCustomers());
}));
customerRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res
        .status(200)
        .send((0, jsonResponses_1.successJson)(yield controllers_1.default.getCustomerById(id)));
}));
customerRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res
        .status(201)
        .send((0, jsonResponses_1.successJson)(yield controllers_1.default.insertCustomer(name, age, title, company)));
}));
customerRouter.put("/updateName/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // #swagger.tags = ['Customers']
    const id = new mongoose_1.default.Types.ObjectId(req.params.id);
    const name = req.body.name;
    res
        .status(200)
        .send((0, jsonResponses_1.successJson)(yield controllers_1.default.updateName(id, name)));
}));
customerRouter.post("/resetAges", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.status(200).send((0, jsonResponses_1.successJson)(numResets));
}));
